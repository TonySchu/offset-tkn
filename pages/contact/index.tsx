        ...
        <main className="main" id="top">
            ...
            <section className="bg-extra-1 py-0">
                <div
                    ...
                    style={{
                        backgroundImage:
                            "url(assets/img/bg-img/contact-bg.png)",
                    }}
                ></div>
                {/*/.bg-holder*/}
                <div
                        ...
                        <div className="col-lg-6 col-md-7 col-10 pt-10 pb-9">
                            ...
                            <div className="overflow-hidden">
                                <p className="text-100 mt-4 w-lg-75">
                                    Does your project need a jumpstart? Our best
                                    customers have a graveyard of design system
                                    attempts that just haven't quite caught on.
                                    They’re ready to bring in some outside help
                                    to gain traction. Sound familiar? We’d love
                                    to chat.
                                </p>
                            </div>
                        </div>
            ...
            <section className="pt-0 bg-extra-1">
                <div
                    ...
                    style={{
                        backgroundImage:
                            "url(assets/img/bg-img/contact-form-bg.svg)",
                        ...
                        <div className="col-xl-11 col-lg-10 text-center">
                            ...
                            >
                                <div className="marker-content">
                                    ...
                                    <p className="mb-0">
                                        Gustave Eiffel's iconic, wrought-iron
                                        1889 tower,
                                        <br />
                                        with steps and elevators to observation
                                        decks.
                                    </p>
                                </div>
                            </div>
                                ...
                                <div className="card-body p-md-6 p-4">
                                    <div className="text-center">
                                        ...
                                        <p className="text-600 w-lg-75 mx-auto mt-3">
                                            you’re precisely the person whom
                                            we’d love to hear from. Drop us a
                                            line and let us know what’s on your
                                            mind.
                                        </p>
                                    </div>
            ...
            <section className="py-0 bg-dark">
                <div
                    ...
                    style={{
                        backgroundImage:
                            "url(assets/img/bg-img/CTA-contact.png)",
                    }}
                ></div>
                {/*/.bg-holder*/}
                <div className="container">
