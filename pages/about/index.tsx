  ...
  return (
    <main className="main" id="top">
      <nav className="navbar navbar-dark  navbar-border-bottom navbar-theme  fixed-top navbar-expand-lg py-3 sticky-kit">
        <div className="container">
          <a className="navbar-brand" href="/">
            <img src="assets/img/logos/primary.png" alt="logo" width={100} />
          </a>
          <button
        ...
        <div className="container">
              ...
              <h1 className="font-weight-medium text-white fs-xl-5 fs-4">
                <span className="position-relative">
                  ...
                  <span
                    ...
                    style={{
                      backgroundImage:
                        "url(assets/img/illustrations/shapes-13.png)",
                      height: 70,
                      width: 80,
                    }}
                  />
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10 mt-xxl-11 mt-xl-9 mt-8">
              <img
                className="shapes-left-top d-none d-md-block"
                src="assets/img/illustrations/shapes-3.png"
                style={{ width: "6%" }}
              />
              <img
                className="shapes-right-bottom d-none d-md-block"
                src="assets/img/illustrations/about-shapes3.png"
                style={{ width: "6%" }}
              />
              ...
              <div className="position-relative">
                ...
                <div className="row">
                  <div className="col-xxl col-xl-11 col-md-10">
                    <img
                      className="position-absolute d-none d-md-block b-0"
                      src="assets/img/illustrations/about-side-shape.png"
                      style={{ width: "41%", right: "-19%" }}
                    />
                    <img
              ...
              <div className="row justify-content-end">
                <div className="col-lg-11 col-6">
                  <img
                    ...
                    src="assets/img/illustrations/home/jhiri-1.png"
                    style={{ width: "20%" }}
                  />
                  <img
                ...
                <div className="col-lg-8 mt-lg-4 col-6">
                  <img
                    className="jhiri-right-bottom"
                    src="assets/img/illustrations/about-jhiri.png"
                    style={{ width: "38%" }}
                  />
                  <img
                    ...
                    <div className="row d-flex my-4 flex-center">
                      ...
                      <div className="col-xl-6 col-lg col-md-6 text-center text-md-left">
                        ...
                        <p className="text-500">
                          A design platform should unite code, content, and
                          design, helping people in each discipline collaborate.
                    ...
                    <div className="row d-flex my-4 flex-center">
                      ...
                      <div className="col-xl-6 col-lg col-md-6 text-center text-md-left">
                        ...
                        <p className="text-500">
                          ...
                          whatever you like. Here at Shape we we work on that
                          for you.
                        </p>
                        <div className="row justify-content-center justify-content-md-start">
                          <div className="col-auto">
      ...
      <section className="py-0 bg-dark">
        <div
          className="bg-holder"
          style={{ backgroundImage: "url(assets/img/bg-img/CTA-primary.png)" }}
        ></div>
        {/*/.bg-holder*/}
        <div className="container">
          <div className="row">
              ...
              <h3 className="text-white fs-lg-3 fs-2">
                <span className="position-relative">
                  ...
                  <span
                    ...
                    style={{
                      backgroundImage:
                        "url(assets/img/illustrations/shapes-12.png)",
                      height: 70,
                      width: 81,
                    }}
                  />
          ...
          <div className="row justify-content-center justify-content-lg-between">
            ...
            <div className="col-lg-3 col-sm-6 mr-auto">
              ...
              <div className="media mt-4">
                <span
                  className="fas fa-map-marker mr-3 mt-1 text-danger"
              ...
              <div className="media mt-1">
                <span
                  className="fas fa-envelope mr-3 mt-1 text-danger"
                  data-fa-transform="down-2"
                />
                <div className="media-body">
            ...
            <div className="col-xxl-3 col-xl-4 col-lg-5 col-md-8 col-10 text-center mt-5 mt-lg-0">
              ...
              <form className="mailbluster-subscribe">
                ...
                <div className="form-group row">
                  ...
                  />
                  <button
                    className="btn btn-block btn-sm mt-3 btn-primary"
                    type="submit"
                  >
                    Subscribe
                  </button>
