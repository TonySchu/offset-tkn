                            ...
                            >
                                <div className="row d-flex flex-center my-4">
                                    ...
                                    <div className="col-xxl-7 col-xl-7 col-lg-8 col-md-7 col-10 text-center text-md-left">
                                        ...
                                        <p className="text-900">
                                            ...
                                            content, and design, helping people
                                            in each discipline collaborate. And
                                            That is Shape for you.
                                        </p>
                                ...
                                <div className="row d-flex flex-center my-4">
                                    ...
                                    <div className="col-xxl-7 col-xl-7 col-lg-8 col-md-7 col-10 text-center text-md-left">
                                        ...
                                        <p className="text-900">
                                            Web publishing platforms should
                                            empower you to build whatever you
                                            like. Here at Shape we we work on
                                            that for you.
                                        </p>
                                        <div className="row justify-content-center justify-content-md-start">
                                            <div className="col-auto">
