                                ...
                                <div className="row justify-content-center">
                                    <div className="col-xxl-6 col-xl-7 col-lg-9 col-md-10 mb-4">
                                        ...
                                        <p className="text-900 mt-4 mx-auto">
                                            ...
                                            easier than ever with our design
                                            system. The Shape allows you to make
                                            changes to your colors, icons within
                                            your app.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="row mt-7 justify-content-center">
                                ...
                                <div className="media p-xxl-4">
                                    ...
                                    <div className="media-body ml-3">
                                        ...
                                        <p className="text-900">
                                            its easy, simple and just a few
                                            clicks job to create an account with
                                            shape
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-4 col-md-8 mb-4 mb-lg-0">
                                <div className="media p-xxl-4">
                                    ...
                                    <div className="media-body ml-3">
                                        <h5 className="font-weight-bold">
                                            Start building beautiful Apps With
                                            shape
                                        </h5>
                                        <p className="text-900">
                                            with our design system, you will
                                            find it no brainers job to build
                                            your application
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="row flex-center">
                            <div className="col-xxl-5 col-lg-6 col-md-10">
                                ...
                                <p className="text-500 mt-4 w-xl-75">
                                    With our built-in design system, it's easy
                                    to create beautiful screens with ease. And
                                    because we separate style from layout, you
                                    can try out new themes instantly.
                                </p>
                        ...
                        <div className="row flex-center text-center text-lg-left">
                            ...
                            <div className="col-xl col-lg-7 col-10">
                                ...
                                <p className="text-500 w-md-75 mx-auto mx-lg-0">
                                    ...
                                    integrations and supports almost every
                                    platform.
                                </p>
                            ...
                            <div className="col-xxl-5 col-xl-6 col-lg-7 col-11 pt-8 pb-xl-8 pb-4 pl-xxl-0 pl-xl-6 order-xl-1">
                                ...
                                <div className="text-center text-xl-left position-relative">
                                    ...
                                    <p className="text-900 mt-4 w-lg-75 mx-lg-auto mx-xl-0">
                                        A design dummy text for this content,
                                        and design, helping people in each
                                        discipline collaborate. And That is
                                        Shape for you.
                                    </p>
                                ...
                                >
                                    <div className="row d-flex flex-center my-4">
                                        ...
                                        <div className="col-xxl-7 col-xl-7 col-lg-8 col-md-7 col-10 text-center text-md-left">
                                            ...
                                            <p className="text-900">
                                                A design platform should unite
                                                code, content, and design,
                                                helping people in each
                                                discipline collaborate. And That
                                                is Shape for you.
                                            </p>
                                    ...
                                    <div className="row d-flex flex-center my-4">
                                        ...
                                        <div className="col-xxl-7 col-xl-7 col-lg-8 col-md-7 col-10 text-center text-md-left">
                                            ...
                                            <p className="text-900">
                                                ...
                                                empower you to build whatever
                                                you like. Here at Shape we we
                            ...
                            <div className="col-xxl-5 col-xl-7 col-lg-8 col-md-10 text-center py-lg-7 py-6">
                                ...
                                <div className="position-relative">
                                    ...
                                    <p className="text-white mt-md-4">
                                        Secure your spot in our beta with just
                                        an email
                                    </p>
