        ...
        <DefaultTemplate SEO={{ ...SEO }}>
            <section className="bg-dark py-xxl-11 py-xl-8 py-lg-6 py-0 ">
                <div
                    ...
                    style={{
                        backgroundImage:
                            "url(assets/img/bg-img/home-header.png)",
                    }}
                ></div>
                {/*/.bg-holder*/}
                <div
                    ...
                    style={{
                        backgroundImage:
                            "url(assets/img/bg-img/appland_bg_companies.svg)",
                        ...
                        <div className="col">
                            <div className="position-relative text-center z-index-1 mb-4">
                                ...
                                <p className="fs-md-2 fs-0 text-capitalize mt-4 mx-auto">
                                    The fastest way to assemble beautiful
                                    screens and then
                                    <br />
                            ...
                            <div className="row justify-content-center">
                                <div className="col-xxl-6 col-xl-7 col-lg-9 col-md-10 mb-4">
                                    ...
                                    <p className="text-900 mt-4 mx-auto">
                                        Updating branding in your app is now
                                        easier than ever with our design system.
                                        The Shape allows you to make changes to
                            ...
                            <div className="media p-xxl-4">
                                ...
                                <div className="media-body ml-3">
                                    ...
                                    <p className="text-900">
                                        its easy, simple and just a few clicks
                                        job to create an account with shape
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-8 mb-4 mb-lg-0">
                            <div className="media p-xxl-4">
                                ...
                                <div className="media-body ml-3">
                                    ...
                                    <p className="text-900">
                                        with our design system, you will find it
                                        no brainers job to build your
                                        application
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-8 mb-4 mb-lg-0">
                            <div className="media p-xxl-4">
                                ...
                                <div className="media-body ml-3">
                                    ...
                                    <p className="text-900">
                                        make it, bake it, and next thing you
                                        know your cake is ready. enjoy it!
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-xxl-11 py-xl-9 py-lg-11 pb-md-7 pt-10 overflow-hidden">
                <div
                    ...
                    style={{
                        backgroundImage:
                            "url(assets/img/bg-img/by-its-default.svg)",
                    }}
                ></div>
                {/*/.bg-holder*/}
                <div className="container">
                    <div className="row flex-center">
                        <div className="col-xxl-5 col-lg-6 col-md-10">
                            ...
                            <p className="text-500 mt-4 w-xl-75">
                                With our built-in design system, it's easy to
                                create beautiful screens with ease. And because
                                we separate style from layout, you can try out
                                new themes instantly.
                            </p>
                    ...
                    <div className="row flex-center text-center text-lg-left">
                        ...
                        <div className="col-xl col-lg-7 col-10">
                            ...
                            <p className="text-500 w-md-75 mx-auto mx-lg-0">
                                our system goes with almost any kind of
                                integrations and supports almost every platform.
                            </p>
                        ...
                        <div className="col-xxl-5 col-xl-6 col-lg-7 col-11 pt-8 pb-xl-8 pb-4 pl-xxl-0 pl-xl-6 order-xl-1">
                            ...
                            <div className="text-center text-xl-left position-relative">
                                ...
                                <p className="text-900 mt-4 w-lg-75 mx-lg-auto mx-xl-0">
                                    A design dummy text for this content, and
                                    design, helping people in each discipline
                                    collaborate. And That is Shape for you.
                                </p>
                                ...
                                <a
                                    className="btn btn-extra mx-2 mt-3"
                                    href="#!"
                                >
                                    Learn More
                                </a>
                        ...
                        <div className="col-xl-6 col-lg-9 col-md-11 col-sm-10 pb-8 pb-xl-0">
                            ...
                            >
                                ...
                                >
                                    ...
                                    content, and design, helping people in each
                                    discipline collaborate. And That is Shape
                                    for you.
                                </Profile>
                                <Profile
                                    name="Mila dalush"
                                ...
                                >
                                    Web publishing platforms should empower you
                                    to build whatever you like. Here at Shape we
                                    we work on that for you.
                                </Profile>
                                <Profile
                                    name="Mila dalush"
                                    roles="business developement manager"
            ...
            <section className="py-0">
                <div
                    ...
                    style={{
                        backgroundImage:
                            "url(assets/img/bg-img/bg-cta-home.png)",
                    }}
                ></div>
                {/*/.bg-holder*/}
                <div className="container">
                    <div className="row justify-content-end align-items-center no-gutters">
                        ...
                        <div className="col-xxl-5 col-xl-7 col-lg-8 col-md-10 text-center py-lg-7 py-6">
                            <div
                                ...
                                style={{
                                    backgroundImage:
                                        "url(assets/img/bg-img/appland_bg12.png)",
                                }}
                            ></div>
                            {/*/.bg-holder*/}
                            <div className="position-relative">
                                ...
                                <p className="text-white mt-md-4">
                                    Secure your spot in our beta with just an
                                    email
                                </p>
